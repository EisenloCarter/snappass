...
public class SM2Utils 
{
	...
	public static boolean verifySign(byte[] userId, ECPoint userKey, byte[] sourceData, byte[] signData) throws IOException
	{
		if (sourceData == null || sourceData.length == 0)
		{
			return false;
	...
	public static void main(String[] args) throws Exception 
	{
		...
		String prik = "00000008BD433C6C068C8D803DFF79792A519A55171B1B650C23661D15897263";
		...
		String prik1 = "12000008BD433C6C068C8D803DFF79792A519A55171B1B650C23661D15897263";
        ...
        String kks = Util.getHexString(kkk);
